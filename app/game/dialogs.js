app.value('dialogs', {
    ...
    kefir: {
        look: {
            text: "K Это фанаты и им весело."
        },
        talk: {
            text: "K ГГ: Привет, куда все пропали?",
            next: {
                text: "K ИИИИгогого, пропали и хорошо, рыбу не пугают."
            }
        },
        death: {
            text: "K ГГ: Ура! Я нашел РОЗУ? Оо"
        }
    }
});
